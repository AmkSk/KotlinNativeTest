...
- (int32_t)getSumFirst:(int32_t)first second:(int32_t)second __attribute__((swift_name("getSum(first:second:)")));
- (NSArray<NSString *> *)sliceFilterAndSortList:(NSArray<NSString *> *)list __attribute__((swift_name("sliceFilterAndSort(list:)")));
@end;
...
- (NSString *)getHelperType __attribute__((swift_name("getHelperType()")));
@property (readonly) int32_t helperId;
@end;

__attribute__((objc_subclassing_restricted))
@interface BaseModel : KotlinBase
- (instancetype)initWithId:(int32_t)id type:(NSString *)type __attribute__((swift_name("init(id:type:)"))) __attribute__((objc_designated_initializer));
- (int32_t)component1 __attribute__((swift_name("component1()")));
- (NSString *)component2 __attribute__((swift_name("component2()")));
- (BaseModel *)doCopyId:(int32_t)id type:(NSString *)type __attribute__((swift_name("doCopy(id:type:)")));
@property int32_t id;
...
@property (class, readonly) NSString *API_KEY;
@end;
